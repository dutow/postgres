 ...
 * (GROUP BY, DISTINCT, DISTINCT ON, or window PARTITION BY) uses for the
 * column the Var references, or InvalidOid if the Var does not participate in
 * that grouping.  Returning InvalidOid signals "not a grouping column" to both
 * the opfamily and collation checks.
 */
